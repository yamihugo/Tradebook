...
export class CalendarView extends ItemView {
  ...
  openDayLog(dateKey: string): void {
    openDayLogModal(this.plugin, this.trades, dateKey, this.plugin.settings.timeZone);
  }
}
 ...
 */
export function openDayLogModal(plugin: TradingJournalPlugin, allTrades: Trade[], dateKey: string, timeZone: string): void {
